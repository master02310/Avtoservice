namespace Avtopark
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FirstCar"/> class.
        /// </summary>
        ...
        public FirstCar(double price, double fuel_consumption, string brand, string classification, string color)
